...
crawl_date: "2025-11-29T14:34:29.779149Z"
selector: "article"
---
...
* **If you want to read the latest value of props or state without “reacting” to it and re-synchronizing the Effect,** you can split your Effect into a reactive part (which you’ll keep in the Effect) and a non-reactive part (which you’ll extract into something called an *Effect Event*). [Read about separating Events from Effects.](/learn/separating-events-from-effects)
...
[PreviousYou Might Not Need an Effect](/learn/you-might-not-need-an-effect)[NextSeparating Events from Effects](/learn/separating-events-from-effects)