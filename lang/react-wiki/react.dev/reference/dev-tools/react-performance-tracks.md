...
crawl_date: "2025-11-29T16:11:44.680661Z"
selector: "article"
---
...
![React Performance Tracks](/images/docs/performance-tracks/overview.png)![React Performance Tracks](/images/docs/performance-tracks/overview.dark.png)
...
![Scheduler track](/images/docs/performance-tracks/scheduler.png)![Scheduler track](/images/docs/performance-tracks/scheduler.dark.png)
...
![Scheduler track: updates](/images/docs/performance-tracks/scheduler-update.png)![Scheduler track: updates](/images/docs/performance-tracks/scheduler-update.dark.png)
...
![Scheduler track: cascading updates](/images/docs/performance-tracks/scheduler-cascading-update.png)![Scheduler track: cascading updates](/images/docs/performance-tracks/scheduler-cascading-update.dark.png)
...
![Components track: render durations](/images/docs/performance-tracks/components-render.png)![Components track: render durations](/images/docs/performance-tracks/components-render.dark.png)
...
![Components track: effects durations](/images/docs/performance-tracks/components-effects.png)![Components track: effects durations](/images/docs/performance-tracks/components-effects.dark.png)
...
![Components track: changed props](/images/docs/performance-tracks/changed-props.png)![Components track: changed props](/images/docs/performance-tracks/changed-props.dark.png)

### Server

![React Server Performance Tracks](/images/docs/performance-tracks/server-overview.png)![React Server Performance Tracks](/images/docs/performance-tracks/server-overview.dark.png)
