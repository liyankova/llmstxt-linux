---
source_url: "https://yazi-rs.github.io/blog/why-is-yazi-fast"
title: "Why is Yazi fast? | Yazi"
crawl_date: "2025-11-16T14:54:53.464486Z"
selector: "article"
---

# Why is Yazi fast? | Yazi
...
## Tokio[​](#tokio "Direct link to Tokio")
...
## Pre-Loading[​](#pre-loading "Direct link to Pre-Loading")
...
## Discardable Tasks[​](#discardable-tasks "Direct link to Discardable Tasks")
...
## Code Highlighting[​](#code-highlighting "Direct link to Code Highlighting")
...
Since code highlighting is a CPU-bound task, it is distributed among multiple blocking threads, managed through Tokio's spawn\_blocking, and is also discardable.

## Image Preview[​](#image-preview "Direct link to Image Preview")
...
## Async Task Scheduling[​](#async-task-scheduling "Direct link to Async Task Scheduling")
