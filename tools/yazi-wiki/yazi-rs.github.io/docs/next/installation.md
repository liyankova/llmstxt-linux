---
source_url: "https://yazi-rs.github.io/docs/next/installation"
title: "Installation | Yazi"
crawl_date: "2025-11-16T14:54:21.763073Z"
selector: "article"
---
...
* [nerd-fonts](https://www.nerdfonts.com/) ([*recommended*](/docs/faq#dont-like-nerd-fonts))
...
## Packaging status[​](#packaging "Direct link to Packaging status")
...
[![Yazi packaging status](https://repology.org/badge/vertical-allrepos/yazi.svg)](https://repology.org/project/yazi/versions)

## Arch Linux[​](#arch "Direct link to Arch Linux")
...
## Nix flakes[​](#flakes "Direct link to Nix flakes")
...
### Install with Scoop[​](#install-with-scoop "Direct link to Install with Scoop")
...
### Install with WinGet[​](#install-with-winget "Direct link to Install with WinGet")
...
## Debian based Linux[​](#debian "Direct link to Debian based Linux")
...
## Fedora/Centos Stream 9+/RHEL 9+[​](#copr "Direct link to Fedora/Centos Stream 9+/RHEL 9+")
...
## Snapcraft[​](#snapcraft "Direct link to Snapcraft")

[![Install Yazi from Snapcraft](https://snapcraft.io/en/dark/install.svg)](https://snapcraft.io/yazi)
...
## Flatpak[​](#flatpak "Direct link to Flatpak")
...
[![Install Yazi from Flathub](https://flathub.org/api/badge?locale=en)](https://flathub.org/apps/io.github.sxyazi.yazi)
...
## crates.io[​](#crates "Direct link to crates.io")
...
## Build from source[​](#source "Direct link to Build from source")
...
## Build from source in debug mode[​](#debug "Direct link to Build from source in debug mode")
