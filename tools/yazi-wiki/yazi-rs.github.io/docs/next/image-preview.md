---
source_url: "https://yazi-rs.github.io/docs/next/image-preview"
title: "Image Preview | Yazi"
crawl_date: "2025-11-16T14:55:00.268909Z"
selector: "article"
---
...
| [Rio](https://github.com/raphamorim/rio) | [Inline images protocol](https://iterm2.com/documentation-images.html) | ❌ Rio renders images at incorrect sizes |
...
## tmux users[​](#tmux "Direct link to tmux users")
...
## Zellij users[​](#zellij "Direct link to Zellij users")
...
## Windows users[​](#windows "Direct link to Windows users")
...
## Windows with WSL users[​](#wsl "Direct link to Windows with WSL users")
...
## Neovim users[​](#neovim "Direct link to Neovim users")
...
## Why won't my images adapt to terminal size?[​](#size "Direct link to Why won't my images adapt to terminal size?")

The size of the image depends on two factors:

1. The [max\_width](/docs/configuration/yazi#preview.max_width) and [max\_height](/docs/configuration/yazi#preview.max_height) config options, which need to be adjusted by the user as needed.
...
## How can I know what image protocol Yazi uses?[​](#protocol "Direct link to How can I know what image protocol Yazi uses?")
...
## Why can't I preview images via Überzug++?[​](#debug-ueberzug "Direct link to Why can't I preview images via Überzug++?")
