---
source_url: "https://yazi-rs.github.io/docs/next/quick-start"
title: "Quick Start | Yazi"
crawl_date: "2025-11-16T14:54:55.670078Z"
selector: "article"
---
...
## Shell wrapper[​](#shell-wrapper "Direct link to Shell wrapper")
...
| `z` | [Cd](/docs/configuration/keymap#mgr.cd) to a directory or [reveal](/docs/configuration/keymap#mgr.reveal) a file via fzf |
| `Z` | [Cd](/docs/configuration/keymap#mgr.cd) to a directory via zoxide |
...
### Copy paths[​](#copy-paths "Direct link to Copy paths")
...
### Filter files[​](#filter-files "Direct link to Filter files")

| Key binding | Action |
| --- | --- |
| `f` | Filter files |

### Find files[​](#find-files "Direct link to Find files")
...
### Multi-tab[​](#multi-tab "Direct link to Multi-tab")
...
## Flavors[​](#flavors "Direct link to Flavors")
