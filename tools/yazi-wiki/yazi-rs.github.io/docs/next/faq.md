---
source_url: "https://yazi-rs.github.io/docs/next/faq"
title: "Frequently Asked Questions | Yazi"
crawl_date: "2025-11-16T14:55:22.884564Z"
selector: "article"
---

# Frequently Asked Questions | Yazi
...
## Why is Yazi fast?[​](#why-yazi-fast "Direct link to Why is Yazi fast?")

See [Why is Yazi fast?](/blog/why-is-yazi-fast).

## Why can't I edit text files?[​](#why-cant-edit "Direct link to Why can't I edit text files?")
...
## Why can't I open/edit/preview files?[​](#why-cant-preview "Direct link to Why can't I open/edit/preview files?")
...
## Why is my text color not distinct?[​](#why-text-indistinct "Direct link to Why is my text color not distinct?")
...
## Why can't "Open" and "Enter" be a single command?[​](#why-separate-open-enter "Direct link to Why can't \"Open\" and \"Enter\" be a single command?")
...
## Why do my icons shrink in [kitty](https://sw.kovidgoyal.net/kitty/), and enlarge when scrolling?[​](#why-icons-shrink "Direct link to why-icons-shrink")
...
## How to troubleshoot terminal response timeout errors?[​](#trt "Direct link to How to troubleshoot terminal response timeout errors?")
...
5. Comment out all custom configurations *except* [passthrough](/docs/image-preview#tmux) to check if the issue is caused by your settings. If so, add them back piece by piece to identify the cause.

## Why is "orphan" set to false by default?[​](#why-orphan-false "Direct link to Why is \"orphan\" set to false by default?")
...
## I don't like nerd‐fonts![​](#dont-like-nerd-fonts "Direct link to I don't like nerd‐fonts!")
...
## Why doesn't the XXX feature exist?[​](#why-no-xxx "Direct link to Why doesn't the XXX feature exist?")
