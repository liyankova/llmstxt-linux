---
source_url: "https://yazi-rs.github.io/docs/next/plugins/overview"
title: "Plugins (BETA) | Yazi"
crawl_date: "2025-11-16T14:55:02.841599Z"
selector: "article"
---
...
### Functional plugin[​](#functional-plugin "Direct link to Functional plugin")
...
## Sync vs Async[​](#sync-vs-async "Direct link to Sync vs Async")
...
### Sync context[​](#sync-context "Direct link to Sync context")
...
Yazi initializes the `state` for each *sync* plugin before running, and it exists independently for them throughout the entire lifecycle.
...
### Async context[​](#async-context "Direct link to Async context")
...
### Preloader[​](#preloader "Direct link to Preloader")
...
## Sendable value[​](#sendable "Direct link to Sendable value")
...
## Ownership transfer[​](#ownership "Direct link to Ownership transfer")
...
### Debugging preset plugins[​](#debugging-preset-plugins "Direct link to Debugging preset plugins")
