---
source_url: "https://sw.kovidgoyal.net/kitty/unscroll/"
title: "Unscrolling the screen - kitty"
crawl_date: "2025-11-16T14:50:37.327582Z"
selector: "article"
---

# Unscrolling the screen - kitty

# Unscrolling the screen[¶](#unscrolling-the-screen "Link to this heading")

This is a small extension to the [SD (Pan up) escape code](https://vt100.net/docs/vt510-rm/SD.html) from the VT-420 terminal. The `SD`
...
a trailing `+` modifier. This is legal under the [ECMA 48 standard](https://www.ecma-international.org/publications-and-standards/standards/ecma-48/)
...
See [discussion here](https://gitlab.freedesktop.org/terminal-wg/specifications/-/issues/30).

Added in version 0.20.2.
