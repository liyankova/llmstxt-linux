---
source_url: "https://sw.kovidgoyal.net/kitty/faq/"
title: "Frequently Asked Questions - kitty"
crawl_date: "2025-11-16T14:49:39.032125Z"
selector: "article"
---

# Frequently Asked Questions - kitty

# Frequently Asked Questions[¶](#frequently-asked-questions "Link to this heading")

## Some special symbols are rendered small/truncated in kitty?[¶](#some-special-symbols-are-rendered-small-truncated-in-kitty "Link to this heading")
...
can be turned off for specific symbols using [`narrow_symbols`](../conf/#opt-kitty.narrow_symbols).

As of version 0.40 kitty has innovated a [new protocol](../text-sizing-protocol/) that allows programs running in the terminal to control
...
## Using a color theme with a background color does not work well in vim?[¶](#using-a-color-theme-with-a-background-color-does-not-work-well-in-vim "Link to this heading")

First, be sure to [use a color scheme in vim](https://github.com/kovidgoyal/kitty/discussions/8196#discussioncomment-11739991)
...
Furthermore, it [recently broke detection even more](https://github.com/vim/vim/issues/11729).
...
## I get errors about the terminal being unknown or opening the terminal failing or functional keys like arrow keys don’t work?[¶](#i-get-errors-about-the-terminal-being-unknown-or-opening-the-terminal-failing-or-functional-keys-like-arrow-keys-don-t-work "Link to this heading")
...
[shell integration](../shell-integration/) on the remote machine.

This [ssh kitten](../kittens/ssh/) takes all the same command line arguments
...
If this does not work, see [Copying terminfo files manually](../kittens/ssh/#manual-terminfo-copy) for alternative ways to
...
[`TERMINFO`](../glossary/#envvar-TERMINFO) environment variable which is what points to the kitty
terminfo files.

First, make sure the [`TERM`](../glossary/#envvar-TERM) is set to `xterm-kitty` in the sudo
...
Alternately, you can configure **sudo** to preserve [`TERMINFO`](../glossary/#envvar-TERMINFO)
...
This will make [`TERMINFO`](../glossary/#envvar-TERMINFO) available
...
## I cannot use the key combination X in program Y?[¶](#i-cannot-use-the-key-combination-x-in-program-y "Link to this heading")
...
likely they have not added support for [Comprehensive keyboard handling in terminals](../keyboard-protocol/).
...
## How do I change the colors in a running kitty instance?[¶](#how-do-i-change-the-colors-in-a-running-kitty-instance "Link to this heading")

The easiest way to do it is to use the [themes kitten](../kittens/themes/),
...
Or you can enable [remote control](../remote-control/) for *kitty* and use
[kitten @ set-colors](../remote-control/#at-set-colors). The shortcut mapping technique has the same syntax as the
remote control command, for details, see [kitten @ set-colors](../remote-control/#at-set-colors).

To change colors when SSHing into a remote host, use the [`color_scheme`](../kittens/ssh/#opt-kitten-ssh.color_scheme) setting for the [ssh kitten](../kittens/ssh/).

Additionally, You can use the
[OSC terminal escape codes](https://invisible-island.net/xterm/ctlseqs/ctlseqs.html#h3-Operating-System-Commands)
...
examples. See [XParseColor](https://linux.die.net/man/3/xparsecolor)
for full details.

If a `?` is given rather than a color specification, kitty will respond
with the current value for the specified color.

## How do I specify command line options for kitty on macOS?[¶](#how-do-i-specify-command-line-options-for-kitty-on-macos "Link to this heading")
...
cleverly adds itself to the [`PATH`](../glossary/#envvar-PATH).

## I catted a binary file and now kitty is hung?[¶](#i-catted-a-binary-file-and-now-kitty-is-hung "Link to this heading")
...
closing sequence. Press [`ctrl+shift+delete`](../conf/#shortcut-kitty.Reset-the-terminal) to reset the terminal.

If you do want to cat unknown data, use `cat -v`.

## kitty is not able to use my favorite font?[¶](#kitty-is-not-able-to-use-my-favorite-font "Link to this heading")
...
If you are trying to use a font patched with [Nerd Fonts](https://nerdfonts.com/) symbols, don’t do that as patching destroys
...
add the following line to `kitty.conf`:
...
Those Unicode symbols not in the [Unicode private use areas](https://en.wikipedia.org/wiki/Private_Use_Areas) are
not included.
...
On macOS, you can open *Font Book* and look in the Fixed width
...
## How can I assign a single global shortcut to bring up the kitty terminal?[¶](#how-can-i-assign-a-single-global-shortcut-to-bring-up-the-kitty-terminal "Link to this heading")

Use the [panel kitten](../kittens/quick-access-terminal/#quake), this allows you to use kitty as a quick
access Quake like terminal and even to use kitty as the desktop background, if
so desired.

## I do not like the kitty icon![¶](#i-do-not-like-the-kitty-icon "Link to this heading")
...
[![https://github.com/k0nserv/kitty-icon/raw/main/kitty.iconset/icon_256x256.png](https://github.com/k0nserv/kitty-icon/raw/main/kitty.iconset/icon_256x256.png)](https://github.com/k0nserv/kitty-icon)
[![https://github.com/DinkDonk/kitty-icon/raw/main/kitty-dark.png](https://github.com/DinkDonk/kitty-icon/raw/main/kitty-dark.png)](https://github.com/DinkDonk/kitty-icon)
[![https://github.com/DinkDonk/kitty-icon/raw/main/kitty-light.png](https://github.com/DinkDonk/kitty-icon/raw/main/kitty-light.png)](https://github.com/DinkDonk/kitty-icon)
[![https://github.com/hristost/kitty-alternative-icon/raw/main/kitty_icon.png](https://github.com/hristost/kitty-alternative-icon/raw/main/kitty_icon.png)](https://github.com/hristost/kitty-alternative-icon)
[![https://github.com/igrmk/whiskers/raw/main/whiskers.svg](https://github.com/igrmk/whiskers/raw/main/whiskers.svg)](https://github.com/igrmk/whiskers)
[![https://github.com/samholmes/whiskers/raw/main/whiskers.png](https://github.com/samholmes/whiskers/raw/main/whiskers.png)](https://github.com/samholmes/whiskers)
[![https://github.com/user-attachments/assets/a37d7830-4a8c-45a8-988a-3e98a41ea541](https://github.com/user-attachments/assets/a37d7830-4a8c-45a8-988a-3e98a41ea541)](https://github.com/diegobit/kitty-icon)
[![https://github.com/eccentric-j/eccentric-icons/raw/main/icons/kitty-terminal/2d/kitty-preview.png](https://github.com/eccentric-j/eccentric-icons/raw/main/icons/kitty-terminal/2d/kitty-preview.png)](https://github.com/eccentric-j/eccentric-icons)
[![https://github.com/eccentric-j/eccentric-icons/raw/main/icons/kitty-terminal/3d/kitty-preview.png](https://github.com/eccentric-j/eccentric-icons/raw/main/icons/kitty-terminal/3d/kitty-preview.png)](https://github.com/eccentric-j/eccentric-icons)
[![https://github.com/sodapopcan/kitty-icon/raw/main/kitty.app.png](https://github.com/sodapopcan/kitty-icon/raw/main/kitty.app.png)](https://github.com/sodapopcan/kitty-icon)
[![https://github.com/sfsam/some_icons/raw/main/kitty.app.iconset/icon_128x128@2x.png](https://github.com/sfsam/some_icons/raw/main/kitty.app.iconset/icon_128x128@2x.png)](https://github.com/sfsam/some_icons)
[![https://github.com/igrmk/twiskers/raw/main/icon/twiskers.svg](https://github.com/igrmk/twiskers/raw/main/icon/twiskers.svg)](https://github.com/igrmk/twiskers)

You can put `kitty.app.icns` (macOS only) or `kitty.app.png` in the
[kitty configuration directory](../conf/#confloc), and this icon will be applied
automatically at startup. On X11 and Wayland, this will set the icon for kitty windows.
Note that not all Wayland compositors support the [protocol needed](https://wayland.app/protocols/xdg-toplevel-icon-v1)
...
1. Copy `kitty.desktop` from the installation location (usually
   `/usr/share/applications` to `~/.local/share/applications`
2. Edit the copied desktop file changing the `Icon` line to have
   the absolute path to your desired icon.

## How do I map key presses in kitty to different keys in the terminal program?[¶](#how-do-i-map-key-presses-in-kitty-to-different-keys-in-the-terminal-program "Link to this heading")

This is accomplished by using `map` with [`send_key`](../actions/#action-send_key) in `kitty.conf`.
For example:
...
This causes the program running in kitty to receive the `ctrl`+`s` key when
you press the `alt`+`s` key and several keystrokes when you press
`ctrl`+`alt`+`2`. To see this in action, run:
...
than a key press, see [`send_text`](../conf/#shortcut-kitty.Send-arbitrary-text-on-key-presses) instead.

## How do I open a new window or tab with the same working directory as the current window?[¶](#how-do-i-open-a-new-window-or-tab-with-the-same-working-directory-as-the-current-window "Link to this heading")
...
as the current window. The [launch command](../launch/) is very powerful,
explore [its documentation](../launch/).

## Things behave differently when running kitty from system launcher vs. from another terminal?[¶](#things-behave-differently-when-running-kitty-from-system-launcher-vs-from-another-terminal "Link to this heading")
...
rc files are either also defined system wide or via the [`env`](../conf/#opt-kitty.env) directive in
`kitty.conf`. Common environment variables that cause issues are those
related to localization, such as [`LANG`](../glossary/#envvar-LANG), `LC_*` and loading of
configuration files such as `XDG_*`, [`KITTY_CONFIG_DIRECTORY`](../glossary/#envvar-KITTY_CONFIG_DIRECTORY) and,
most importantly, `PATH` to locate binaries.

The simplest way to fix this is to have kitty load the environment variables
from your shell configuration at startup using the [`env`](../conf/#opt-kitty.env) directive,
adding the following to `kitty.conf`:
...
## I am using tmux/zellij and have a problem[¶](#i-am-using-tmux-zellij-and-have-a-problem "Link to this heading")

First, terminal multiplexers are [a bad idea](https://github.com/kovidgoyal/kitty/issues/391#issuecomment-638320745),
do not use them, if at all possible. kitty contains features that do all of what
tmux does, but better, with the exception of remote persistence ([#391](https://github.com/kovidgoyal/kitty/issues/391)).
If you still want to use tmux, read on.

Using ancient versions of tmux such as 1.8 will cause gibberish on screen when
pressing keys ([#3541](https://github.com/kovidgoyal/kitty/issues/3541)).

If you are using tmux with multiple terminals or you start it under one terminal
and then switch to another and these terminals have different [`TERM`](../glossary/#envvar-TERM)
...
placeholders](../graphics-protocol/#graphics-unicode-placeholders) workaround that kitty created
for tmux refusing to support images.

If you use any of the advanced features that kitty has innovated, such as
[styled underlines](../underlines/), [desktop notifications](../desktop-notifications/), [variable sized text](../text-sizing-protocol/),
[extended keyboard support](../keyboard-protocol/),
[file transfer](../kittens/transfer/), [the ssh kitten](../kittens/ssh/),
[shell integration](../shell-integration/) etc. they may or may not work,
depending on the whims of tmux’s maintainer, your version of tmux, etc.

## I opened and closed a lot of windows/tabs and top shows kitty’s memory usage is very high?[¶](#i-opened-and-closed-a-lot-of-windows-tabs-and-top-shows-kitty-s-memory-usage-is-very-high "Link to this heading")
...
To check for memory leaks, instead use a tool like [Valgrind](https://valgrind.org/). Run:
...
## Why does kitty sometimes start slowly on my Linux system?[¶](#why-does-kitty-sometimes-start-slowly-on-my-linux-system "Link to this heading")
...
([#4292](https://github.com/kovidgoyal/kitty/issues/4292)) to take ≈2 seconds, by running *kitty* as:
