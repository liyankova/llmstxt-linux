---
source_url: "https://sw.kovidgoyal.net/kitty/multiple-cursors-protocol/"
title: "The multiple cursors protocol - kitty"
crawl_date: "2025-11-16T14:50:23.865819Z"
selector: "article"
---

# The multiple cursors protocol - kitty

# The multiple cursors protocol[¶](#the-multiple-cursors-protocol "Link to this heading")

Added in version 0.43.0.

Warning

This protocol is under public discussion in [#8927](https://github.com/kovidgoyal/kitty/issues/8927). It is subject to
...
terminal have many niceties like smooth animation [[anim]](#anim), auto adjust colors [[rv]](#rv),
...
## Clearing previously set multi-cursors[¶](#clearing-previously-set-multi-cursors "Link to this heading")
...
## Changing the color of extra cursors[¶](#changing-the-color-of-extra-cursors "Link to this heading")
...
## Querying for already set cursors[¶](#querying-for-already-set-cursors "Link to this heading")
...
## Querying for extra cursor colors[¶](#querying-for-extra-cursor-colors "Link to this heading")
...
section [Changing the color of extra cursors](#extra-cursor-color) for details.

## Interaction with other terminal controls and state[¶](#interaction-with-other-terminal-controls-and-state "Link to this heading")
...
**Clearing the screen**
:   The escape codes used to clear the screen ([ED](https://vt100.net/docs/vt510-rm/ED.html))
...
## Footnotes[¶](#footnotes "Link to this heading")

[[anim](#id1)]

kitty allows the cursor blink to be [`animated`](../conf/#opt-kitty.cursor_blink_interval) using any CSS easing function. This cannot be
implemented using fake cursors.

[[rv](#id2)]

kitty has a special “reverse video” color mode for cursors where the
