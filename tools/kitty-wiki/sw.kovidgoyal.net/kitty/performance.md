---
source_url: "https://sw.kovidgoyal.net/kitty/performance/"
title: "Performance - kitty"
crawl_date: "2025-11-16T14:49:46.463011Z"
selector: "article"
---
...
[vector CPU instructions](https://en.wikipedia.org/wiki/Single_instruction,_multiple_data) for
...
[`repaint_delay`](../conf/#opt-kitty.repaint_delay) and [`input_delay`](../conf/#opt-kitty.input_delay). These control the artificial delays
introduced into the render loop to reduce CPU usage. See
[Performance tuning](../conf/#conf-kitty-performance) for details. See also the [`sync_to_monitor`](../conf/#opt-kitty.sync_to_monitor)
option to further decrease latency at the cost of some [screen tearing](https://en.wikipedia.org/wiki/Screen_tearing) while scrolling.
...
### Keyboard to screen latency[¶](#keyboard-to-screen-latency "Link to this heading")

This is measured either with dedicated hardware, or software such as [Typometer](https://pavelfatin.com/typometer/). Third party measurements comparing
...
[Hardware based measurement on macOS](https://thume.ca/2020/05/20/making-a-latency-tester/) show that kitty and
Apple’s Terminal.app share the crown for best latency. These
measurements were done with [`input_delay`](../conf/#opt-kitty.input_delay) at its default value of `3 ms`
which means kitty’s actual numbers would be even lower.

[Typometer based measurements on Linux](https://github.com/kovidgoyal/kitty/issues/2701#issuecomment-911089374)
show that kitty has far and away the best latency of the terminals tested.

### Throughput[¶](#throughput "Link to this heading")
...
konsole, gnome-terminal and xterm do not support the [Synchronized update](https://gitlab.com/gnachman/iterm2/-/wikis/synchronized-updates-spec)
...
### Energy usage[¶](#energy-usage "Link to this heading")
...
## Instrumenting kitty[¶](#instrumenting-kitty "Link to this heading")

You can generate detailed per-function performance data using
[gperftools](https://github.com/gperftools/gperftools). Build *kitty* with
