---
source_url: "https://sw.kovidgoyal.net/kitty/kittens/developing-builtin-kittens/"
title: "Developing builtin kittens - kitty"
crawl_date: "2025-11-16T14:48:53.689108Z"
selector: "article"
---

# Developing builtin kittens - kitty

# Developing builtin kittens[¶](#developing-builtin-kittens "Link to this heading")
...
`my_kitten` in the `kittens` directory. Then, in this directory
add three, files: `__init__.py` (an empty file), `__main__.py` and
`main.go`.

### Template for main.py[¶](#template-for-main-py "Link to this heading")
...
### Template for main.go[¶](#template-for-main-go "Link to this heading")
...
### Edit `tools/cmd/tool/main.go`[¶](#edit-tools-cmd-tool-main-go "Link to this heading")

Add the entry point of the kitten into `tools/cmd/tool/main.go`.

First, import the kitten into this file. To do this, add `"kitty/kittens/my_kitten"` into the `import ( ... )` section at the top.
