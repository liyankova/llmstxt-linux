---
source_url: "https://sw.kovidgoyal.net/kitty/clipboard/"
title: "Copying all data types to the clipboard - kitty"
crawl_date: "2025-11-16T14:50:51.830492Z"
selector: "article"
---

# Copying all data types to the clipboard - kitty

# Copying all data types to the clipboard[¶](#copying-all-data-types-to-the-clipboard "Link to this heading")
...
base64 encoded data. `OSC` is `<ESC>[`.
`ST` is the string terminator, `<ESC>\`.

## Reading data from the system clipboard[¶](#reading-data-from-the-system-clipboard "Link to this heading")
...
## Writing data to the system clipboard[¶](#writing-data-to-the-system-clipboard "Link to this heading")
...
## Avoiding repeated permission prompts[¶](#avoiding-repeated-permission-prompts "Link to this heading")

Added in version 0.42.2: using a password to avoid repeated confirmations
...
## Support for terminal multiplexers[¶](#support-for-terminal-multiplexers "Link to this heading")
