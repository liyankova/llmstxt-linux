---
source_url: "https://sw.kovidgoyal.net/kitty/underlines/"
title: "Colored and styled underlines - kitty"
crawl_date: "2025-11-16T14:50:06.468501Z"
selector: "article"
---

# Colored and styled underlines - kitty

# Colored and styled underlines[¶](#colored-and-styled-underlines "Link to this heading")

*kitty* supports colored and styled (wavy) underlines. This is of particular use
in terminal based text editors such as **vim** and **emacs** to
...
terminals ([CSI codes](https://en.wikipedia.org/wiki/ANSI_escape_code#CSI_(Control_Sequence_Introducer)_sequences))
