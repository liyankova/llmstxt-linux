---
source_url: "https://sw.kovidgoyal.net/kitty/layouts/"
title: "Arrange windows - kitty"
crawl_date: "2025-11-16T14:48:13.142563Z"
selector: "article"
---

# Arrange windows - kitty

# Arrange windows[¶](#arrange-windows "Link to this heading")
...
[![Screenshot, showing three programs in the 'Tall' layout](../_images/screenshot.png)](../_images/screenshot.png)

Screenshot, showing **vim**, **tig** and **git**
running in *kitty* with the *Tall* layout[¶](#id1 "Link to this image")

[![Screenshot, showing windows in the 'Splits' layout](../_images/splits.png)](../_images/splits.png)

Screenshot, showing windows with arbitrary arrangement in the *Splits*
layout[¶](#id2 "Link to this image")

There are many different layouts available. They are all enabled by default, you
can switch layouts using [`next_layout`](../actions/#action-next_layout) ([`ctrl+shift+l`](../conf/#shortcut-kitty.Next-layout) by default). To
control which layouts are available use [`enabled_layouts`](../conf/#opt-kitty.enabled_layouts), the first listed
layout becomes the default. Individual layouts and how to use them are described
below.

# The Stack Layout[¶](#the-stack-layout "Link to this heading")
...
# The Tall Layout[¶](#the-tall-layout "Link to this heading")
...
# The Fat Layout[¶](#the-fat-layout "Link to this heading")
...
# The Grid Layout[¶](#the-grid-layout "Link to this heading")
...
# The Splits Layout[¶](#the-splits-layout "Link to this heading")
...
define a few extra key bindings in `kitty.conf`:
...
Windows can be resized using [Resizing windows](#window-resizing). You can swap the windows
...
are placed into vertical or horizontal splits when a [`--location`](../launch/#cmdoption-launch-location) is not specified. A value of `horizontal` (same as
...
Added in version 0.17.0: The Splits layout

# The Horizontal Layout[¶](#the-horizontal-layout "Link to this heading")
...
# The Vertical Layout[¶](#the-vertical-layout "Link to this heading")
...
# Resizing windows[¶](#resizing-windows "Link to this heading")

You can resize windows inside layouts. Press [`ctrl+shift+r`](../conf/#shortcut-kitty.Start-resizing-window) (also
...
You can also define shortcuts in `kitty.conf` to make the active window
wider, narrower, taller, or shorter by mapping to the [`resize_window`](../actions/#action-resize_window)
action, for example:
...
The [`resize_window`](../actions/#action-resize_window) action has a second optional argument to control
...
how the available space is split up. To specify the option, in [`kitty.conf`](../conf/#opt-kitty.enabled_layouts) use:
