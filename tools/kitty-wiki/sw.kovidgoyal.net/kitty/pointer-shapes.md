---
source_url: "https://sw.kovidgoyal.net/kitty/pointer-shapes/"
title: "Mouse pointer shapes - kitty"
crawl_date: "2025-11-16T14:50:34.649073Z"
selector: "article"
---

# Mouse pointer shapes - kitty

# Mouse pointer shapes[¶](#mouse-pointer-shapes "Link to this heading")
...
## Setting the pointer shape[¶](#setting-the-pointer-shape "Link to this heading")
...
[Pointer shape names](#pointer-shape-names) table.

## Pushing and popping shapes onto the stack[¶](#pushing-and-popping-shapes-onto-the-stack "Link to this heading")
...
shape names. See the [Pointer shape names](#pointer-shape-names) table. All the specified names
...
## Querying support[¶](#querying-support "Link to this heading")
...
## Interaction with other terminal features[¶](#interaction-with-other-terminal-features "Link to this heading")
...
## Pointer shape names[¶](#pointer-shape-names "Link to this heading")
...
property in the CSS standard](https://developer.mozilla.org/en-US/docs/Web/CSS/cursor), click the link to
...
## Legacy xterm compatibility[¶](#legacy-xterm-compatibility "Link to this heading")

The original xterm proposal for this escape code used shape names from the
`X11/cursorfont.h` header on X11 based systems. Terminal implementations
wishing to maintain compatibility with xterm can also implement these names as
aliases for the CSS based names defined in the [Pointer shape names](#pointer-shape-names) table.
