...
Here, it needs to have an element of type GtkMenu with id "menu". Eeach actions in menu-actions are  linked  to  ele‐
ments in the menu-file file by the id of the elements.
