---
source_url: "https://docs.noctalia.dev/getting-started/compositor-settings/"
title: "Compositor Settings | Noctalia Docs"
crawl_date: "2025-11-16T08:46:24.510571Z"
selector: "main"
---
...
[Section titled “Niri configuration”](#niri-configuration)
...
[Section titled “Niri wallpaper and overview setup”](#niri-wallpaper-and-overview-setup)

Next choose one of the following options for your wallpaper and overview setup.

### Option 1: Blurred Overview Wallpaper

[Section titled “Option 1: Blurred Overview Wallpaper”](#option-1-blurred-overview-wallpaper)
...
![Blurred Overview Wallpaper](/_astro/option1.BVNhyECB_Zchkga.webp)
...
[Section titled “Option 2: Stationary Wallpaper”](#option-2-stationary-wallpaper)
...
![Stationary Wallpaper](/_astro/option2.DOeuvBbH_l2Hnh.webp)
...
// Set transparent workspace background color so you see the backdrop at all time.
...
[Section titled “Option 3: Flat colored overview”](#option-3-flat-colored-overview)

If you prefer a more productivity oriented look, you can use this minimal configuration.

![Flat colored overview](/_astro/option3.CMRqNWK1_gduAx.webp)
