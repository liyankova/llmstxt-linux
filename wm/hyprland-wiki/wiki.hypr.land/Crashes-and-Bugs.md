---
source_url: "https://wiki.hypr.land/Crashes-and-Bugs/"
title: "Crashes and Bugs – Hyprland Wiki"
crawl_date: "2025-11-21T17:59:14.354970Z"
selector: "article"
---
...
These variables will enable *very* verbose logging and it’s not recommended to enable them unless debugging, as they
might cause slowdowns and *massive* log files.

Try to reproduce your issue as fast as possible so we don’t have to sift through 1 million lines of logs.

## Bugs

First of all, ***READ THE [FAQ PAGE](../FAQ)***
...
*git* will now checkout a commit in the middle of the specified range.
...
Reset, build and install Hyprland again and repeat this step until *git* identifies the
