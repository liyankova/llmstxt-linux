---
source_url: "https://wiki.hypr.land/Nvidia/"
title: "NVidia – Hyprland Wiki"
crawl_date: "2025-11-21T17:59:09.460776Z"
selector: "article"
---
...
There is no *official* Hyprland support for Nvidia hardware. However, many
...
Electron apps. However, it needs to be *manually enabled* by adding the below flag
...
1. Try changing the primary GPU [with the AQ\_DRM\_DEVICES environment variable](https://wiki.hypr.land/Configuring/Multi-GPU/#telling-hyprland-which-gpu-to-use).
