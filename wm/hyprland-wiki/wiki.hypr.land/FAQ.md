---
source_url: "https://wiki.hypr.land/FAQ"
title: "FAQ – Hyprland Wiki"
crawl_date: "2025-11-21T17:59:37.552572Z"
selector: "article"
---
...
and try compiling with LEGACY\_RENDERER
...
By switching your laptop to only use the dGPU in the BIOS, you *might* be able
to get everything to work, at the cost of high battery usage.

*Please note these are highly model-specific and might or might not work. If
they don’t, you’re unfortunately out of luck.*
...
For Qt applications, Hyprland exports XCURSOR\_SIZE as 24, which is the default.
You can overwrite this by exporting XCURSOR\_SIZE to a different value with `env`.
...
Make sure to also edit `~/.config/gtk-4.0/settings.ini` and `~/.gtkrc-2.0` if *not* using a tool
(like `nwg-look`).
...
This is a side effect of the [decoration:blur:new\_optimizations](../Configuring/Variables/#blur).
