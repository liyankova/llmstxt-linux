---
source_url: "https://wiki.hypr.land/Contributing-and-Debugging/PR-Guidelines/"
title: "PR Guidelines – Hyprland Wiki"
crawl_date: "2025-11-21T17:59:25.580443Z"
selector: "article"
---
...
*only* ignore them if it’s absolutely necessary.
...
This is a simple rule - don’t use raw pointers (e.g. `CMyClass*`) unless *absolutely necessary*. You have `UP`, `SP` and `WP` at your disposal.
...
[Issue Guidelines](/Contributing-and-Debugging/Issue-Guidelines/ "Issue Guidelines")[Translations](/Contributing-and-Debugging/Translations/ "Translations")