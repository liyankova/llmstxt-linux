---
source_url: "https://wiki.hypr.land/Hypr-Ecosystem/hypridle/"
title: "hypridle – Hyprland Wiki"
crawl_date: "2025-11-21T17:57:30.594834Z"
selector: "article"
---
...
| `before_sleep_cmd` | command to run when receiving a dbus prepare\_sleep event | string | empty |
| `after_sleep_cmd` | command to run when receiving a dbus post prepare\_sleep event | string | empty |
...
[hyprlauncher](/Hypr-Ecosystem/hyprlauncher/ "hyprlauncher")[hyprlock](/Hypr-Ecosystem/hyprlock/ "hyprlock")