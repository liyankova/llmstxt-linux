---
source_url: "https://danklinux.com/docs/"
title: "Welcome | Dank Linux"
crawl_date: "2025-11-16T08:41:20.624344Z"
selector: "article"
---
...
![DankDash Overview](/img/dankdashlight.png)![DankDash Overview](/img/dankdash.png)

DankMaterialShell's DankDash with a Suite of DankBar Widgets

## The Suite[​](#the-suite "Direct link to The Suite")

* **[DankMaterialShell](/docs/dankmaterialshell/overview)** - A feature-rich desktop shell built with [Quickshell](https://quickshell.org/) and [Go](https://golang.org/).
* **[dgop](/docs/dgop/)** - A stateless, cursor-based system and process monitoring tool with a tui, cli, and REST API.
* **[dsearch](/docs/danksearch/)** - Extremely fast, configurable, zero-dependency indexed filesystem search service.
* **[dankinstall](/docs/dankinstall/)** - An automated installer and management tool for the entire Dank Linux suite
...
![Control Center](/img/cclight.png)![Control Center](/img/cc.png)
...
![Desktop Overview](/img/desktoplight.png)![Desktop Overview](/img/desktop.png)
...
![DGOP Preview](/img/dgoplight.png)![DGOP Preview](/img/dgop.png)
...
![DankSearch](/img/dsearchlight.png)![DankSearch](/img/dsearch.png)
...
* [DankMaterialShell/dms backend + dankinstall](https://github.com/AvengeMedia/DankMaterialShell/backend)
...
Ready to dive in? Head over to the [Getting Started](/docs/getting-started) guide to begin your Dank Linux journey!
