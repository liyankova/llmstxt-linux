---
source_url: "https://quickshell.org/docs/v0.2.1/guide/install-setup"
title: "Installation & Setup"
crawl_date: "2025-11-16T14:36:19.775014Z"
selector: ".docslayout"
---
...
4. [Guide](/docs/v0.2.1/guide)
5. [Install-setup](/docs/v0.2.1/guide/install-setup)
...
* `qt5compat`: extra visual effects, notably gaussian blur. [MultiEffect](https://doc.qt.io/qt-6/qml-qtquick-effects-multieffect.html) is usually preferable
...
Quickshell is available from the [errornointernet/quickshell](https://copr.fedorainfracloud.org/coprs/errornointernet/quickshell) COPR, as either:
...
Read the [Usage Guide](/docs/v0.2.1/guide) after configuring your editor.
...
Create your first configuration by reading the [Intro](/docs/v0.2.1/guide/introduction).
